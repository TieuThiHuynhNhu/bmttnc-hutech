...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_sign.setGeometry(QtCore.QRect(90, 220, 631, 131))
        self.txt_sign.setObjectName("txt_sign")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(310, 20, 211, 20))
        font = QtGui.QFont()
        ...
        self.txt_info.setGeometry(QtCore.QRect(90, 80, 631, 101))
        self.txt_info.setObjectName("txt_info")
        self.btn_gen_keys = QtWidgets.QPushButton(self.centralwidget)
        self.btn_gen_keys.setGeometry(QtCore.QRect(490, 30, 131, 23))
        self.btn_gen_keys.setObjectName("btn_gen_keys")
        self.btn_sign = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(160, 410, 141, 23))
        self.btn_sign.setObjectName("btn_sign")
        self.btn_verify = QtWidgets.QPushButton(self.centralwidget)
        self.btn_verify.setGeometry(QtCore.QRect(1180, 620, 91, 23))
        ...
        self.btn_verify_2.setGeometry(QtCore.QRect(540, 410, 91, 23))
